...
{	
	...
	public void refresh(Collection<String> userIdsCol){
			...
			HashMap<String,ArrayList<Long>> userBrowsedMap=getBrowsedHistoryMap();
	 ...
	 * @return
	 */
	private HashMap<String,ArrayList<Long>> getBrowsedHistoryMap(){
	...
	private HashSet<Long> getBrowsedNewsSet(){
		HashMap<String,ArrayList<Long>> browsedMap=getBrowsedHistoryMap();
