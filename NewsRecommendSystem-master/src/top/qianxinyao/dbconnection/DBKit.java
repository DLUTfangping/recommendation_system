...
public class DBKit{
	...
	public static MySQLJDBCDataModel getMySQLJDBCDataModel_(){
		return new MySQLJDBCDataModel(DBKit.getDataSource(),PREF_TABLE,PREF_TABLE_USERID,PREF_TABLE_NEWSID,
				PREF_TABLE_PREFVALUE,PREF_TABLE_TIME);
	}
}
