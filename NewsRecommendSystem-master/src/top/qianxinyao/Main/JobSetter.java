...
public class JobSetter
{
	 ...
	 * @param userList
	 */
	private void executeQuartzJob(List<String> userList) {
		//设定推荐任务每天的执行时间
	 ...
	 */
	public void executeQuartzJobForCertainUsers(List<String> goalUserList) {
	 ...
	 */
	private void executeInstantJob(List<String> userIDList) {
		//让热点新闻推荐器预先生成今日的热点新闻
	 ...
	 * @param forActiveUsers
	 */
	public void executeInstantJobForCertainUsers(List<String> goalUserList) {
